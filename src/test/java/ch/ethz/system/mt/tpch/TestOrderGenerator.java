...
import static ch.ethz.system.mt.tpch.MTUtils.NUM_DOMAINS;
...
public class TestOrderGenerator
{
    ...
    {
        assertEntityLinesMD5(new OrderGenerator(scaleFactor, step, children, new int[] {1}, new int[] {1}, new int[1][NUM_DOMAINS]), expectedMD5);
    }
}

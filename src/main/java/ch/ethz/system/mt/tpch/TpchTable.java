...
public abstract class TpchTable<E extends TpchEntity>
{
    ...
    {
        public Iterable<Customer> createGenerator(double scaleFactor, int part, int partCount, int[] tenantSize, int[][] formatIndexes)
        {
            return new CustomerGenerator(scaleFactor, part, partCount, tenantSize, formatIndexes);
        }
    };

    public static final TpchTable<Order> ORDERS = new TpchTable<Order>("orders", OrderColumn.values())
    {
        public Iterable<Order> createGenerator(double scaleFactor, int part, int partCount, int[] tenantSize, int[][] formatIndexes)
        {
            return new OrderGenerator(scaleFactor, part, partCount, tenantSize, tenantSize, formatIndexes);
        }
    };
    ...
    {
        public Iterable<LineItem> createGenerator(double scaleFactor, int part, int partCount, int[] tenantSize, int[][] formatIndexes)
        {
            return new LineItemGenerator(scaleFactor, part, partCount, tenantSize, formatIndexes);
        }
    };

    public static final TpchTable<Part> PART = new TpchTable<Part>("part", PartColumn.values())
    {
        public Iterable<Part> createGenerator(double scaleFactor, int part, int partCount, int[] tenantSize, int[][] formatIndexes)
        {
    ...
    {
        public Iterable<PartSupplier> createGenerator(double scaleFactor, int part, int partCount, int[] tenantSize, int[][] formatIndexes)
        {
    ...
    {
        public Iterable<Supplier> createGenerator(double scaleFactor, int part, int partCount, int[] tenantSize, int[][] formatIndexes)
        {
    ...
    {
        public Iterable<Nation> createGenerator(double scaleFactor, int part, int partCount, int[] tenantSize, int[][] formatIndexes)
        {
            if (part != 1) {
    ...
    {
        public Iterable<Region> createGenerator(double scaleFactor, int part, int partCount, int[] tenantSize, int[][] formatIndexes)
        {
            if (part != 1) {
                return ImmutableList.of();
            }
    ...
    public abstract Iterable<E> createGenerator(double scaleFactor, int part, int partCount, int[] tenantSize, int[][] formatIndexes);
